  ...
  return (
    <div className="p-8">
                ...
                <tr key={kpi.kpi_id} className="hover:bg-slate-50 transition">
                  ...
                  <td className="px-4 py-3 text-center">
                    <div className="flex items-center justify-center gap-2">
                      <button onClick={() => startEdit(kpi)} className="p-1.5 text-amber-500 hover:bg-amber-50 rounded-lg transition"><Pencil className="w-3.5 h-3.5" /></button>
      ...
      <style>{`
        ...
        .input-field { @apply w-full px-3 py-2 rounded-lg border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 transition; }
        .btn-primary { @apply px-5 py-2 bg-primary hover:bg-primary/90 text-primary-foreground text-sm font-medium rounded-lg transition disabled:opacity-60 shadow-sm; }
